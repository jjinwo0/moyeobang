INSERT INTO member (age, created_at, updated_at, birth, created_by, email, member_key, modified_by, profile, username,
                    gender, member_type,
                    role)
VALUES (25, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1998-01-15', 'admin', 'member1@example.com', 'MKEY001',
        'admin', 'profile1.jpg',
        'John Doe', 'MALE', 'GOOGLE', 'MEMBER'),
       (30, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1993-03-12', 'admin', 'member2@example.com', 'MKEY002',
        'admin', 'profile2.jpg',
        'Jane Doe', 'FEMALE', 'KAKAO', 'MEMBER'),
       (27, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1996-07-21', 'admin', 'member3@example.com', 'MKEY003',
        'admin', 'profile3.jpg',
        'Michael Smith', 'MALE', 'GOOGLE', 'MEMBER'),
       (22, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '2001-05-18', 'admin', 'member4@example.com', 'MKEY004',
        'admin', 'profile4.jpg',
        'Emily Davis', 'FEMALE', 'KAKAO', 'MEMBER'),
       (35, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1988-11-09', 'admin', 'member5@example.com', 'MKEY005',
        'admin', 'profile5.jpg',
        'Chris Johnson', 'MALE', 'GOOGLE', 'ADMIN'),
       (28, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1995-08-14', 'admin', 'member6@example.com', 'MKEY006',
        'admin', 'profile6.jpg',
        'Anna Brown', 'FEMALE', 'KAKAO', 'MEMBER'),
       (32, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1991-02-24', 'admin', 'member7@example.com', 'MKEY007',
        'admin', 'profile7.jpg',
        'James Taylor', 'MALE', 'GOOGLE', 'MEMBER'),
       (26, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1997-04-30', 'admin', 'member8@example.com', 'MKEY008',
        'admin', 'profile8.jpg',
        'Sophia Lee', 'FEMALE', 'KAKAO', 'MEMBER'),
       (29, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1994-06-17', 'admin', 'member9@example.com', 'MKEY009',
        'admin', 'profile9.jpg',
        'David Wilson', 'MALE', 'GOOGLE', 'MEMBER'),
       (31, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1992-09-08', 'admin', 'member10@example.com', 'MKEY010',
        'admin',
        'profile10.jpg', 'Olivia White', 'FEMALE', 'KAKAO', 'MEMBER'),
       (33, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1990-12-25', 'admin', 'member11@example.com', 'MKEY011',
        'admin',
        'profile11.jpg', 'Matthew Harris', 'MALE', 'GOOGLE', 'MEMBER'),
       (24, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1999-10-03', 'admin', 'member12@example.com', 'MKEY012',
        'admin',
        'profile12.jpg', 'Mia Lewis', 'FEMALE', 'KAKAO', 'MEMBER'),
       (27, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1996-03-29', 'admin', 'member13@example.com', 'MKEY013',
        'admin',
        'profile13.jpg', 'Alexander Walker', 'MALE', 'GOOGLE', 'MEMBER'),
       (26, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1997-07-22', 'admin', 'member14@example.com', 'MKEY014',
        'admin',
        'profile14.jpg', 'Isabella Hall', 'FEMALE', 'KAKAO', 'MEMBER'),
       (30, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1993-01-06', 'admin', 'member15@example.com', 'MKEY015',
        'admin',
        'profile15.jpg', 'Daniel Martinez', 'MALE', 'GOOGLE', 'MEMBER'),
       (35, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1988-04-14', 'admin', 'member16@example.com', 'MKEY016',
        'admin',
        'profile16.jpg', 'Lucas Anderson', 'MALE', 'GOOGLE', 'ADMIN'),
       (23, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '2000-11-18', 'admin', 'member17@example.com', 'MKEY017',
        'admin',
        'profile17.jpg', 'Amelia Thomas', 'FEMALE', 'KAKAO', 'MEMBER'),
       (31, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1992-08-27', 'admin', 'member18@example.com', 'MKEY018',
        'admin',
        'profile18.jpg', 'Henry Robinson', 'MALE', 'GOOGLE', 'MEMBER'),
       (28, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1995-05-13', 'admin', 'member19@example.com', 'MKEY019',
        'admin',
        'profile19.jpg', 'Emma Clark', 'FEMALE', 'KAKAO', 'MEMBER'),
       (34, '2023-09-01 10:00:00', '2023-09-01 10:00:00', '1989-09-30', 'admin', 'member20@example.com', 'MKEY020',
        'admin',
...
VALUES ('2023-09-01 08:00:00', '2023-09-01 08:00:00', 1, '111-222-333', 'admin', 'admin'),
       ('2023-09-01 08:00:00', '2023-09-01 08:00:00', 2, '0012280102000441', 'admin', 'admin');
...
INSERT INTO withdraw (latitude, longitude, amount, balance_snapshot, created_at, updated_at, travel_account_id,
                      created_by, modified_by,
                      place_address, place_id, place_name, target_account_number, title, settle_type)
VALUES (37.5665, 126.9780, 100000, 700000, '2023-09-02 14:00:00', '2023-09-02 14:00:00', 1, 'admin', 'admin',
        'Seoul, South Korea',
        'PID001', 'Namsan Tower', '123-456-789', 'Tour Fee', 'CUSTOM'),
       (37.5745, 126.9574, 50000, 650000, '2023-09-02 16:30:00', '2023-09-02 16:30:00', 1, 'admin', 'admin',
        'Seoul, South Korea', 'PID002',
        'Insadong', '987-654-321', 'Food Payment', 'CUSTOM'),
       (37.5510, 126.9882, 150000, 400000, '2023-09-02 18:00:00', '2023-09-02 18:00:00', 1, 'admin', 'admin',
        'Seoul, South Korea',
        'PID003', 'Dongdaemun', '456-789-123', 'Shopping', 'CUSTOM'),
       (37.5705, 126.9922, 50000, 350000, '2023-09-02 20:00:00', '2023-09-02 20:00:00', 1, 'admin', 'admin',
        'Seoul, South Korea', 'PID004',
