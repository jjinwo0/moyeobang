...
public class CommonHeaders {
    ...
    public static CommonHeaders withUserKey(String userKey, String apiName, LocalDateTime transmissionDateTime) {
        return CommonHeaders.builder()
                .apiName(apiName)
    ...
    private CommonHeaders(String apiName,
