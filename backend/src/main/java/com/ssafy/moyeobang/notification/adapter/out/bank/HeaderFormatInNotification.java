...
public class HeaderFormatInNotification {
    ...
    public static HeaderFormatInNotification withUserKey(String userKey, String apiName, LocalDateTime transmissionDateTime) {
        return HeaderFormatInNotification.builder()
                .apiName(apiName)
    ...
    private HeaderFormatInNotification(String apiName,
