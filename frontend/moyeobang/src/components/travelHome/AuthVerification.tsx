...
//       <div css={authStyle}>
//         <p>본인 인증</p>
//         <Btn buttonStyle={{style: 'blue', size: 'big'}}>본인인증 하러 가기</Btn>
//       </div>
//       <div css={checkStyle}>
//         <p>약관 동의</p>
//         <div css={allAgreeStyle}>
//           <img css={checkIconStyle} src={blackBlankCheck} alt="체크박스" />
//           <span>전체 동의</span>
//         </div>
...
//             <img css={checkIconStyle} src={blackBlankCheck} alt="체크박스" />
//             <span>[필수] 모임 통장 이용 약관</span>
//           </div>
//           <img src={oneLeftArrow} css={arrowIconStyle} alt="화살표 아이콘" />
//         </div>

//         <div className="terms-item">
//           <div className="terms-text">
//             <img css={checkIconStyle} src={blackBlankCheck} alt="체크박스" />
//             <span>[필수] 계좌간 자동이체 약관</span>
//           </div>
//           <img src={oneLeftArrow} css={arrowIconStyle} alt="화살표 아이콘" />
//         </div>
...
import {css} from '@emotion/react';
import blackBlankCheck from '@/assets/icons/blackBlankCheck.png';
import blackCheck from '@/assets/icons/blackCheck.png'; // 선택된 체크박스 이미지
import oneLeftArrow from '@/assets/icons/oneLeftArrow.png';
import Btn from '../common/btn/Btn';
