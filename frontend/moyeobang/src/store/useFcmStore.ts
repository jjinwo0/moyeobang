...
// Custom storage object for Zustand using sessionStorage
const sessionStoragePersist: PersistStorage<FcmTokenState> = {
  getItem: name => {
...
const useFcmStore = create<FcmTokenState>()(
  persist(
    ...
    {
      name: 'fcm-token-storage', // 세션스토리지에 저장될 key 이름
      storage: sessionStoragePersist, // Use the custom sessionStorage object
    }
  )
);
